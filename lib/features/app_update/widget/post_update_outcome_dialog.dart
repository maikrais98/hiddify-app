...
enum _PostUpdateCopy {
  russian(
    ...
    canReconnect: 'VPN сейчас отключён. Можно безопасно подключиться снова с активным профилем.',
  ...
  english(
    ...
    canReconnect: 'The VPN is disconnected. You can safely reconnect with the active profile.',
